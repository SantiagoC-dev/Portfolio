...
import Yo3 from '../assets/Yo3.webp';
import Yo4 from '../assets/Yo4.webp';
...
export default function AboutMePage() {
  ...
  // ✅ OPTIMIZACIÓN 1: Eliminado el filtro "blur". Ahora es una transición limpia y ultra ligera.
  const smoothReveal = {
      ...
      <motion.div variants={containerVariants} initial="hidden" animate="visible" className="max-w-6xl mx-auto px-6 sm:px-8">
        ...
        <motion.section className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-16 mb-20 md:mb-32">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left z-10 mt-6 md:mt-0">
            ...
            <motion.h1 variants={smoothReveal} className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-serif text-gray-900 dark:text-white mb-6 tracking-tight leading-tight md:leading-none">
              {t('aboutMe.name')}
            </motion.h1>
            
            <motion.p variants={smoothReveal} className="text-gray-500 dark:text-gray-400 font-light text-base sm:text-lg md:text-xl leading-relaxed max-w-lg mb-8 md:mb-10">
              {t('aboutMe.description')}
            </motion.p>
            
            {/* ─── BOTÓN DESCARGAR CV (MINIMALISTA) ─── */}
            <motion.a 
              variants={smoothReveal} 
              href="/SantiagoCalderonCV.pdf" 
          ...
          {/* Swipe Deck de Fotos */}
          {/* ✅ OPTIMIZACIÓN 3: Eliminado el prop layout y reajustado onDragEnd */}
          <div className="w-full md:w-1/2 h-[450px] sm:h-[500px] md:h-[600px] relative flex justify-center items-center">
            {deck.map((card, index) => {
              ...
              return (
                <motion.div
                  ...
                  animate={{
                    y: index === 0 ? 0 : index === 1 ? -25 : -15,
                    x: index === 0 ? 0 : index === 1 ? 35 : -35,
                    rotate: index === 0 ? -2 : index === 1 ? 6 : -6,
                    scale: index === 0 ? 1 : index === 1 ? 0.92 : 0.85,
                    zIndex: 30 - index,
                    opacity: index === 2 ? 0.5 : 1,
                    filter: index === 0 ? "grayscale(0%)" : "grayscale(40%)",
                  }}
                  transition={{ type: "spring", stiffness: 300, damping: 25 }}
                  className={`absolute w-64 sm:w-72 md:w-80 h-[26rem] sm:h-[30rem] md:h-[400px] rounded-2xl overflow-hidden shadow-2xl bg-white dark:bg-gray-800 border-[6px] border-white dark:border-gray-800 ${isFront ? 'cursor-grab active:cursor-grabbing' : 'cursor-pointer'}`}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            <motion.section variants={smoothReveal} className="mb-16">
            ...
            <motion.section variants={smoothReveal} className="mb-16 lg:mb-0">
              <span className="text-xs font-semibold tracking-widest text-gray-400 uppercase mb-6 block text-center lg:text-left">
                {t('aboutMe.languagesTitle')}
              </span>
              <div className="space-y-6 max-w-sm mx-auto lg:mx-0">
                
                {/* ✅ OPTIMIZACIÓN 2: Uso de scaleX en lugar de width */}
                <div className="group">
                  ...
                  <div className="w-full h-1.5 bg-gray-200 dark:bg-gray-800 rounded-full overflow-hidden relative">
                    <motion.div 
                      ...
                      className="absolute left-0 top-0 h-full w-full bg-gray-900 dark:bg-white rounded-full origin-left" 
                    />
                  </div>
                </div>
                ...
                <div className="group">
                  ...
                  <div className="w-full h-1.5 bg-gray-200 dark:bg-gray-800 rounded-full overflow-hidden relative">
                    <motion.div 
                      ...
                      className="absolute left-0 top-0 h-full w-full bg-[#3178C6] rounded-full origin-left"
                    />
                  </div>
                </div>
          ...
          <div>
            <motion.section variants={smoothReveal} className="mb-16">
              ...
              <div className="relative pl-6 md:pl-8 space-y-10">
                {/* ✅ OPTIMIZACIÓN 2: Uso de scaleY en lugar de height */}
                <motion.div 
                  initial={{ scaleY: 0 }}
                  whileInView={{ scaleY: 1 }}
                  viewport={{ once: true }}
                  transition={{ duration: 1.5, ease: "easeInOut" }}
                  className="absolute left-[3px] top-2 bottom-0 w-[2px] bg-gray-200 dark:bg-gray-800 -z-10 origin-top"
                />
            ...
            <motion.section variants={smoothReveal}>
              <span className="text-xs font-semibold tracking-widest text-gray-400 uppercase mb-6 block text-center lg:text-left">
